...
class Sageweb_Cms_Table_File
{
    ...
    private static function _getRootQuery()
    {
        return Doctrine_Query::create()
            ->from('Sageweb_Cms_PostFile p, p.entity e, p.author a, '
                    . 'p.categories c, p.tags t, p.upload u');
    }

    /**
     * @return Sageweb_Cms_PostFile
     */
    ...
    public static function findPublic()
    {
        return self::_getRootQuery()
            ->where('p.status = ?', Sageweb_Cms_PostArticle::STATUS_PUBLIC)
            ->execute();
    }
