 ...
 */
class Application_Model_Discussion_DiscussionPost extends Sageweb_Abstract_Post
{
    ...
    {
        parent::setUp();
        $this->hasOne('Sageweb_Forum as forum', array(
            'local' => 'forum_id',
            'foreign' => 'id',
        ));
    }
    ...
    public function preSave($event)
    {
        ...
        $this->slug = Application_Converter_Slugify::getSlug($this->_get('title'));
    }
