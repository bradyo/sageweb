 ...
 * 
 * @property Sageweb_Orm_Entity $entity
 *
 * @author Brady Olsen <bradyo@uw.edu>
 */
class Sageweb_Cms_PostComment extends Sageweb_Cms_Abstract_Post
{
    private $_depth;
    ...
    public function postSave($event) {
        ...
        $discussion = Sageweb_Cms_Table_Discussion::findOneByEntityId($this->rootEntityId);
        if ($discussion) {
            $stmt = $db->prepare('
